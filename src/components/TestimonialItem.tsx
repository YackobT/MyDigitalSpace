...
const TestimonialItem: React.FC<TestimonialItemProps> = ({ testimonial }) => {
  ...
  return (
    ...
    >
      ...
      {/* Removed margin (m-2 md:m-4) to avoid "border" perception. Padding is p-6 md:p-8 */}
      {/* Using card_background directly if no image, or a semi-transparent overlay if there is an image */}
      <div 
