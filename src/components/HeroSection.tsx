...
const HeroSection: React.FC = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col items-center justify-center text-center bg-background text-text_primary relative px-4 py-16"
    >
      <motion.div
      ...
      <motion.div
        ...
        className="absolute bottom-8 sm:bottom-12 left-1/2 transform -translate-x-1/2 custom-cursor-hover-target"
      >
