...
<section className="py-16 bg-light">
  ...
  <div className="relative border-l border-primary max-w-4xl mx-auto pl-6">
    ...
    <div className="mb-10 ml-4">
      ...
      <h3 className="text-xl font-semibold text-dark">DS Technologies Inc</h3>
      <span className="text-sm text-gray-500">Integration Business Analyst</span>
      <p className="mt-2 text-gray-700">Led EHR system integrations, streamlined validation testing, and produced user manuals that improved training efficiency by 40%.</p>
    </div>
    
    {/* Job 2 */}
    <div className="mb-10 ml-4">
      <div className="absolute w-4 h-4 bg-primary rounded-full -left-2.5 top-1.5"></div>
      <h3 className="text-xl font-semibold text-dark">CACI</h3>
      <span className="text-sm text-gray-500">Business Analyst</span>
      <p className="mt-2 text-gray-700">Enhanced Agile workflows, reduced sprint rework by 30%, and improved stakeholder alignment across projects.</p>
    </div>

    {/* Job 3 */}
    <div className="mb-10 ml-4">
      <div className="absolute w-4 h-4 bg-primary rounded-full -left-2.5 top-1.5"></div>
      <h3 className="text-xl font-semibold text-dark">Spectrum Financial</h3>
      <span className="text-sm text-gray-500">Business Systems Analyst</span>
      <p className="mt-2 text-gray-700">Automated financial workflows, maintained 98% QA pass rate, and drove a 25% boost in operational efficiency.</p>
    </div>

    {/* Job 4 */}
    <div className="mb-10 ml-4">
      <div className="absolute w-4 h-4 bg-primary rounded-full -left-2.5 top-1.5"></div>
      <h3 className="text-xl font-semibold text-dark">CIM Group</h3>
      <span className="text-sm text-gray-500">Business Systems Support Analyst</span>
      <p className="mt-2 text-gray-700">Supported lease/vendor operations for 500+ units, created rent roll reports, and improved renewal rates.</p>
    </div>

    {/* Job 5 */}
    <div className="ml-4">
      <div className="absolute w-4 h-4 bg-primary rounded-full -left-2.5 top-1.5"></div>
      <h3 className="text-xl font-semibold text-dark">Bell Partners</h3>
      <span className="text-sm text-gray-500">Senior Leasing Manager</span>
      <p className="mt-2 text-gray-700">Boosted occupancy by 10%, ensured Fair Housing compliance, and optimized leasing team performance.</p>
    </div>
  </div>
</section>
